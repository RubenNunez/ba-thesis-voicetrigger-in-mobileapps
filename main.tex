...
fiel auf die \textbf{AVAudioEngine} API für iOS und macOS. Im folgenden Code-Beispiel wird gezeigt, 
wie ein kontinuierlicher Audio-Stream mit AVAudioEngine aufgenommen werden kann.
...
TODO: Gestzte und Regeln für Datenschutz und Privatsphäre
...
\subsection{Versuche}
Als Teil der Ideen und Konzepte wurden verschiedene Versuche gestartet. Diese Versuche sind 
wichtig, um die Machbarkeit der Ideen zu überprüfen. Die Versuche basieren mehrheitlich auf 
die Verwendung des Basismodells von Facebook AI's wav2vec2. Die Versuche wurden mit dem Ziel 
gestartet, ein eigenes Modell zu entwickeln, welches Triggerwörter erkennt.
...
\subsubsection{Versuch 2: Facebook AI wav2vec2 Fine-Tuning}
Nach den ersten Versuchen mit wav2vec2 wurde ein weiterer Versuch gestartet. Nach einem Ansatz 
welches als Fine-Tuning bezeichnet wird. Fine-Tuning ist ein Verfahren, bei dem ein bereits 
vortrainiertes Modell als Basis verwendet wird. Dieses Modell kann dann für eine spezifische 
Aufgabe weiter trainiert werden. Es reduziert dabei den Ökolgischen Fussabdruck, da weniger 
Rechenleistung benötigt wird (\cite{huggingface2023finetune}).
