...
\begin{table}[h]
	...
	Integration in eine Mobile App & \textbf{Spezifisch:} Einbindung des erarbeiteten Modells in 
									 ...
									 Projektzeitrahmens. 
									 \textbf{Terminiert:} Integration bis zur Ausführung der User Tests. \\ \hline
...
kein Ziel dieser Arbeit, einen vollständigen Sprachassistenten zu entwickeln. Die Resultate dieser 
Arbeit könnten aber als Grundlage für eine vollständige Implementierung eines Sprachassistenten 
genutzt werden.
...
\noindent \newline
Die \textit{Precision} zeigt den Anteil der korrekten positiven Vorhersagen an den gesamten positiven Vorhersagen. Die Precision wird wie folgt berechnet:
...
\noindent \newline
Im Gegensatz dazu gibt der \textit{Recall} den Anteil der korrekten positiven Vorhersagen an den gesamten tatsächlich positiven Fällen an. Recall misst somit, wie viele der tatsächlichen positiven Fälle vom System als positiv erkannt wurden. Die Berechnung des Recall erfolgt wie folgt:
