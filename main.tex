...
soll einen Überblick über die Thematik verschaffen. 
...
kein Ziel dieser Arbeit, eine vollständigen Sprachassistenten zu entwickeln. Das würde den Rahmen
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.80\linewidth]{img/wav2vec2_code.png}
...
\subsubsection{Versuch 2: LiteFEW}
...
\subsubsection{Versuch 3: ConvLSTM}
...
\subsection{Google Cloud Platform als Unterstützung}
