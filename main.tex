...
\begin{table}[h]
	...
	Integration in eine Mobile App & \textbf{Spezifisch:} Einbindung des erarbeiteten Modells in 
									 ...
									 \textbf{Messbar:} Funktionale und reibungslose Integration. 
...
Apple sowie Google selbst stellen mit Siri und Google Assistant bereits Sprachassistenten zur 
...
Das Vorgehen dieser Arbeit kann als eine hybride Methode beschrieben werden. Aus der 
...
(\cite{barazanji2023heyditto}) verwendet. Das Modell wurde in PyTorch implementiert und 
anschliessend trainiert. Das Training wurde auf einem MacBook Pro mit einem M1 Pro Chip 
durchgeführt. Die Trainingszeit betrug für 100 Epochen etwa 8 Stunden. Neben der Architektur und 
...
Trainingsprozesses und helfen, die Effektivität der angewandten Trainingsmethodik zu bewerten.
