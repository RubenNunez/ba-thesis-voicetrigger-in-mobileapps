...
insbesondere in Bezug auf das Erkennen von Triggerwörtern. Daher gibt es eine Lücke
...
traditionellenAlgorithmen gelöst werden können. Ein Beispiel dafür ist die Spracherkennung oder 
...
'Hey Siri' verwendet. Das zweite dient als Bestätigung bzw. zusätzlichen Checker.
...
für die Umsetzung verwendet werden. Ebenfalls wird die Notwendigkeit von schneller und 
energieeffizienter Erkennung von 'Hey Siri' deutlich. Dies ist auch für die Umsetzung dieser Arbeit
ein wichtiger Punkt.
...
Wake Word Erkennung könnte es genau die richtige Lösung sein.
