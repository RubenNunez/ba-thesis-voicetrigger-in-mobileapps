...
insbesondere in Bezug auf das Erkennen von \textit{Wake-up} Wörtern. Daher gibt es eine Lücke
...
das Erkennen von \textit{Wake-up} Wörtern oder \textit{Wake-up} Wortsequenzen ermöglicht?"
...
Weiterhin ist Anliegen dieser Arbeit, dass das Thema Datenschutz und die ethischen Aspekte 
...
Um die Grundlagen von Machine Learning im Bereich der Spracherkennung zu verstehen, ist es 
wichtig, die grundlegenden Konzepte von Neuronalen Netzen zu verstehen. Für den Anwendungsbereich 
der Spracherkennung sind vor allem die Deep Neural Networks (DNN), die Convolutional Neural Networks 
(CNN) und die Recurrent Neural Networks (RNN) von Bedeutung. Um diese
