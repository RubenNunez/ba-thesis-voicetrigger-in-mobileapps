...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[node distance=3.75cm, auto, thick, >=Latex]
		...
		\tikzset{block/.style= {draw, rectangle, align=center, minimum width=2.5cm, minimum height=1.25cm, font=\scriptsize}}
		% Nodes
...
\subsubsection{Vergleich von Sprachassistenten}

In der Arbeit von \cite{matarneh2017speechrecognition} werden verschiedene Spracherkennungssysteme 
anhand von Schlüsselparametern wie Genauigkeit, API-Qualität, Leistung, Echtzeitgeschwindigkeit, 
...
\noindent \newline
Zusammenfassend lässt sich sagen, dass Dragon Mobile SDK bei den Closed Source Systeme führend 
in der Genauigkeit und Benutzerfreundlichkeit ist, während CMU Sphinx bei den Open Source Systemen
hervor sticht.
...
Während der Recherche für diese Arbeit wurden natürlich auch die bestehenden Lösungen auf dem Markt
analysiert. Dabei wurde der folgende Anbieter gefunden, welcher exakt eine Lösung für die Trigger
Wort Erkennung anbietet. Der Anbieter heisst Picovoice und bietet eine Lösung mit dem Namen
Porcupine an. Sie beschreiben ihre Lösung wie folgt:
...
Die grundlegende Idee ist es, ein eigenes Modell zu trainieren, ganz nach dem Vorbild von
(\cite{siri2017hey}), welches Triggerwörter erkennt. Die folgende Abbildung \ref{fig:basic_idea}
zeigt die grundlegende Idee als grobe Skizze.
