...
\subsection{Ehtische Überlegungen}
Das Erstellen eines Datensatzes hat eine gewisse Verantwortung. Nicht nur das Datenschutzgesetz 
soll eingehalten werden, sondern auch ethische Überlegungen sollen getroffen werden. Beispielsweise 
sollte der Datensatz nicht nur aus Sprachaufnahmen von bestimmten Personen bestehen. 
(\cite{papakyriakopoulos2023augmented})
