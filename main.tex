...
akustischen Signalen zu erkennen, wobei die Sprachdaten in Spektrogramme umgewandelt wurden.

\noindent \newline
Ein entscheidender Aspekt der Arbeit war die Integration des Modells in eine Echtzeitanwendung für 
mobile Plattformen. Hierfür wurde das Modell mithilfe von PyTorch Scripting in ein für mobile Apps 
geeignetes Format konvertiert und in eine Anwendung eingebettet, die einen kontinuierlichen 
Audio-Stream in Echtzeit verarbeitet. Die Anwendung kann Triggerwörter in 2-Sekunden-Abschnitten 
erkennen, wobei die Inferenz 10-mal pro Sekunde durchgeführt wird, um eine hohe 
Erkennungsgenauigkeit zu gewährleisten.
