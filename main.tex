...
Sprachassistenten genutzt. Während es etablierte Lösungen wie Siri, Google Assistant oder Alexa 
gibt, fehlt es an Lösungen für eine integrierte Sprachsteuerung in Mobile Apps, insbesondere in 
...
\subsection{Ziele}
Die Ziele dieser Arbeit sind in der folgenden Tabelle \ref{tab:smart_goals} aufgeführt. Die Ziele 
sind nach dem SMART-Prinzip formuliert.
